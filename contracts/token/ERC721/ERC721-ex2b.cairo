...
@storage_var
func animals(tokenId : Uint256) -> (animal : Animal):
end
...
func get_animal_characteristics{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (animal) = animals.read(tokenId)
...
func declare_animal{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
    ...
    # write animal characteristics & mint token
    animals.write(tokenId=tokenId, value=Animal(sex=sex, legs=legs, wings=wings))
    Ownable.assert_only_owner()
